...
import CallToActionTwoUp, {
    CallToActionTwoUpComponent,
} from 'components/sections/CallToActionTwoUp';

export default {
    title: 'Sections/CallToActionTwoUp',
    component: CallToActionTwoUpComponent,
    parameters: {
        status: {
...
export const Default: Story = () => (
    <CallToActionTwoUp
        ...
        superTitle="Contact me"
        avatar={{
            src: '/images/placeholders/669/300x300.jpg',
            alt: 'avatar',
        }}
        description={`
                <p>
                ...
                <p class="icon-label icon-label--big icon-label--list">
                    <svg
                        width="25"
                        height="25"
                        viewBox="0 0 25 25"
            ...
            `}
        rightContent="<iframe src='https://pulq.com' width='100%' height='100%'></iframe>"
    />
);
